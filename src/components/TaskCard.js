          ...
          {isDOpen && (
            <div className=" absolute top-9 left-1 w-[200px] py-[10px] border-[0.2px] border-[#98A2B3] bg-[#fff] rounded-[8px] px-3">
              <ul className="flex flex-col gap-3">
                ...
                <li onClick={ToggleEditModalOpen} className="flex items-center w-full">
                  {" "}
                  <Edit
                    variant="Linear"
                    color="#98A2B3"
        ...
        >
          ...
          <ModalContent>
            ...
            <ModalFooter gap={"16px"}>
              <button onClick={closeDeleteModal} className="border-[0.2px]  border-[#98A2B3] w-[99px] text-center rounded-[8px] py-[12px] text-[14px] font-medium text-black">
                Cancel
              </button>
              <button onClick={handleDelete} className="border-[0.2px]  border-[#98A2B3] w-[99px] bg-[#F05800] flex items-center justify-center text-center rounded-[8px] py-[12px] text-[14px] font-medium text-white">
                {isLoading ? (
