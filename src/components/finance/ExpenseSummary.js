...
export const ExpenseSummaryDetails = () => {
  ...
  return (
    <div className=" rounded-[8px] w-full   overflow-auto">
      ...
      <div class="sm:-mx-6 lg:-mx-8">
        <div class="inline-block min-w-full  sm:px-6 lg:px-8">
          <div class="overflow-x-auto">
            <div className="flex ">
              <table className=" mb-6 border-b-[0.8px] border-r-[0.8px]  border-l-[0.8px] border-[#E4E7EC]">
                ...
                {Months &&
                  ...
                  >
                    <td className="whitespace-nowrap py-[16px] bg-[#F9FAFB]  px-5  border-b-[0.8px] border-[#E4E7EC] text-[14px] leading-[24px] tracking-[0.2px] text-[#667185] font-medium text-left  ">
                      {result}
                    </td>
                  </tr>))}
                </tbody>
                ...
                <thead className="bg-light-gray">
                  <tr className="">
                    <th
                      ...
                      className="  border-b-[0.8px] border-[#E4E7EC] py-[12px] gap-[6px] md:gap-[12px] text-[14px] md:text-[16px] text-[#98A2B3]  font-medium leading-[20px] md:leading-[24px] tracking-[0.2%]"
                    >
                      <div className="flex  gap-[6px] md:gap-[12px] items-center">
                       Report
                      </div>
                    </th>
                    <th
...
export default ExpenseSummaryDetails;
