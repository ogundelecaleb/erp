  ...
  return (
    <div>
      <div className="p-[16px] md:p-[20px] flex-between bg-white rounded-tr-lg rounded-tl-lg  border-[0.8px]  border-[#D0D5DD]">
        <p className="text-[18px]  leading-[27px] text-[#000]  ">Purchases</p>
        <button className="px-[4px] py-[4px] bg-[#F05800] shadow text-white text-[14px]  leading-[20px] flex-item gap-2  rounded-[24px]">
