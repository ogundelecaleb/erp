    ...
    <div className="w-56 shrink-0">
      <div className="mb-5 flex items-center justify-between px-[16px] py-[10px] border-[0.2px] border-[#98A2B3] bg-[#fff] rounded-[8px]">
        <div className="flex items-center  gap-2">
          ...
          <div
            className={`bg-[${headingColor}] h-[24px] w-[29px] flex items-center justify-center rounded-md `}
          >
        ...
        <Hashtag variant="Linear" color="#98A2B3" size="24" />{" "}
      </div>
      <div
