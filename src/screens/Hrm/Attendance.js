                ...
                >
                  ...
                  <div className="flex gap-[8px] items-center">
                    ...
                    <p className="text-[14px] underline text-[#667185] leading-[20px]  ">
                      Download Sample Attendance CSV File
                    </p>
                    <DocumentDownload
                      color="#4CAF50"
                      variant="Bold"
        ...
        <div className="p-[10px] md:p-[16px] lg:p-[20px]">
          ...
          <div className="flex items-center gap-4">
            ...
            <select
              ...
              autoFocus
            >
              <option value="High">Select Branch</option>
            ...
            <select
              ...
              autoFocus
            >
              <option value="High">Select Department</option>
              <option value="Medium">Admin</option>
              <option value="Low">Super Admins</option>
            </select>
                      ...
                      <ModalContent>
                        ...
                        >
                          ...
                          <p className="text-[14px]  text-[#667185] leading-[20px] font-normal text-center mt-2  ">
                            Are you sure you want to delete this attendance? This
